...
const match = {
    list: (region, accountId, beginTime) => `https://${region}.api.riotgames.com/lol/match/v4/matchlists/by-account/${accountId}?beginTime=${beginTime}&beginIndex=0&endIndex=10`,
